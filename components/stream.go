...
func NewMMPP(L [][]float64, Q [][]float64, RequstType int, channel *WriteRouter) *MMPP {
...
func NewSimpleStream(delay Delay, RequestType int, channel *WriteRouter) *SimpleInput {
